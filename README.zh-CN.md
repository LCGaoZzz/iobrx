...
[English](README.md) · [教程与图集](tutorials/README.md) · [兼容性说明](docs/PORTABILITY.md)
...
- 每张分析图经历初稿、第一轮版式调整、第二轮精修，采用白底、低饱和配色、细轴线和可编辑矢量文字。参见[逐图修改记录](tutorials/FIGURE_REVIEW.md)。

![CIBERSORT 示例](tutorials/figures/07_cibersort.png)
...
iobrx 代码使用 [MIT](LICENSE)；示例数据保留[上游来源及 GPL-3 条款](tutorials/data/README.md)。
